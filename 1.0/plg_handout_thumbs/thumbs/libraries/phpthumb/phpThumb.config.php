...
$PHPTHUMB_CONFIG['cache_directory'] = null;// MJAZ TURNED OFF CACHE
...
$PHPTHUMB_CONFIG['output_maxwidth']  = 64;      // default maximum thumbnail width.  If this is zero then default width  is the width  of the source image. This is always overridden by ?w=___ GETstring parameter
$PHPTHUMB_CONFIG['output_maxheight'] = 64;      // default maximum thumbnail height. If this is zero then default height is the height of the source image. This is always overridden by ?h=___ GETstring parameter
